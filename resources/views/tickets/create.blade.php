                    ...
                    <form action="{{ route('tickets.store') }}" method="post" class="max-w-sm mx-auto" enctype="multipart/form-data">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="pending" type="radio" name="ticket_status" value="pending" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" {{ old('ticket_status') == 'pending' ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="in-progress" type="radio" name="ticket_status" value="in-progress" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" {{ old('ticket_status') == 'in-progress' ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="close" type="radio" name="ticket_status" value="close" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" {{ old('ticket_status') == 'close' ? 'checked' : '' }}>
